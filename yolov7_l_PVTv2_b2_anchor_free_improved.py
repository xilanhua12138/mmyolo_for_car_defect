...
work_dir = './autodl-tmp/work_dirs/yolov7_l_PVTv2_b2_anchor_free_improved'
...
model = dict(
    backbone=dict(
        _delete_=True,
        type='mmdet.PyramidVisionTransformerV2',
        embed_dims=64,
        num_layers=[3, 4, 6, 3],
        init_cfg=dict(checkpoint='/home/ubuntu/mmyolo/pvt_v2_b2.pth')),
...
# tags=TAGS,
resume="allow",
id="yolov7_l_PVTv2_b2_anchor_free_improved",
